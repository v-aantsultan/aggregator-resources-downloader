...
import com.eci.anaplan.bp.details.aggregations.joiners.BillPaymentDetails
import com.eci.anaplan.bp.details.configs.Config
import com.eci.anaplan.bp.details.services.{S3DestinationService, StatusManagerService}
...
class Coordinator @Inject()(spark: SparkSession,
                            ...
                            anaplanDataframeJoiner: BillPaymentDetails,
  ...
  def coordinate(): Unit = {
    ...
    slack.info(s"Starting Bill Payment Details Aggregator from: $fromDate to: $toDate")
