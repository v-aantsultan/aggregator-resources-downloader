...
import com.eci.anaplan.ci.details.aggregations.joiners.ConnectivityInternationalDetails
import com.eci.anaplan.ci.details.configs.Config
import com.eci.anaplan.ci.details.services.{S3DestinationService, StatusManagerService}
...
class Coordinator @Inject()(spark: SparkSession,
                            ...
                            anaplanDataframeJoiner: ConnectivityInternationalDetails,
  ...
  def coordinate(): Unit = {
    ...
    slack.info(s"Starting Connectivity International in Details Aggregator from: $fromDate to: $toDate")
