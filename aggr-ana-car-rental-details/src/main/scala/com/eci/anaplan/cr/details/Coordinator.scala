...
import com.eci.anaplan.cr.details.services.{S3DestinationService, StatusManagerService}
import com.eci.anaplan.cr.details.aggregations.joiners.CarRentalDetails
...
class Coordinator @Inject()(spark: SparkSession,
                            ...
                            anaplanDataframeJoiner: CarRentalDetails,
  ...
  def coordinate(): Unit = {
    ...
    slack.info(s"Starting Car Rental Details Aggregator from: $fromDate to: $toDate")
