...
import com.eci.anaplan.providers.{LPMutationSlackClient, LPMutationSparkSession}
...
class LPMutationModule extends AbstractModule {
  override def configure(): Unit = {
    ...
    bind(classOf[SlackClient]).toProvider(classOf[LPMutationSlackClient]).asEagerSingleton()
  }
}
