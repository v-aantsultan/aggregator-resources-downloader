package com.eci.anaplan.flight.idr.services
...
class S3SourceService @Inject()(val sparkSession: SparkSession, config: Config,
  ...
  lazy val mappingDimCountryDf: DataFrame = readByDefaultCustomDtl("eci_sheets/ecidtpl_anaplan_fpna/Mapping Dim Country")
  lazy val mappingFulfillmentDf: DataFrame = readByDefaultCustomDtl("eci_sheets/ecidtpl_anaplan_fpna/Mapping fulfillment ID to wholesaler")
