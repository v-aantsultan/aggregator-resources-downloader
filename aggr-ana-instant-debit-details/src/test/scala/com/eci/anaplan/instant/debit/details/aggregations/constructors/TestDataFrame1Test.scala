...
import com.eci.anaplan.instant.debit.details.utils.{SharedBaseTest, TestSparkSession}
...
class TestDataFrame1Test extends SharedBaseTest with TestSparkSession {
  ...
  private val testDiscountPremiumDataFrame: UnderlyingProductSheetDf = new UnderlyingProductSheetDf(testSparkSession, mockS3SourceService)
  before {
