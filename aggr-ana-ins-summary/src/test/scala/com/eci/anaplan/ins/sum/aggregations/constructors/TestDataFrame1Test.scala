...
import com.eci.anaplan.ins.sum.utils.{SharedBaseTest, TestSparkSession}
...
class TestDataFrame1Test extends SharedBaseTest with TestSparkSession {
  ...
  private val testDiscountPremiumDataFrame: INSNonAutoDf = new INSNonAutoDf(testSparkSession, mockS3SourceService)
  before {
