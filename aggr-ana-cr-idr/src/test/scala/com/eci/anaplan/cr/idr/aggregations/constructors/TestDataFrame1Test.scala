package com.eci.anaplan.cr.idr.aggregations.constructors

import com.eci.anaplan.cr.idr.utils.TestSparkSession
import com.eci.anaplan.cr.idr.services.S3SourceService
import com.eci.anaplan.cr.idr.utils.{SharedBaseTest, TestSparkSession}
...
class TestDataFrame1Test extends SharedBaseTest with TestSparkSession {
  ...
  private val testDiscountPremiumDataFrame: ExchangeRateDf = new ExchangeRateDf(testSparkSession, mockS3SourceService)
  before {
