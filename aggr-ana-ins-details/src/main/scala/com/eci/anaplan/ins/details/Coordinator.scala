...
import com.eci.anaplan.ins.details.aggregations.joiners.InsuranceDetails
import com.eci.anaplan.ins.details.configs.Config
import com.eci.anaplan.ins.details.services.{S3DestinationService, StatusManagerService}
...
class Coordinator @Inject()(spark: SparkSession,
                            ...
                            anaplanDataframeJoiner: InsuranceDetails,
  ...
  def coordinate(): Unit = {
    ...
    slack.info(s"Starting Insurance Details Aggregator from: $fromDate to: $toDate")
