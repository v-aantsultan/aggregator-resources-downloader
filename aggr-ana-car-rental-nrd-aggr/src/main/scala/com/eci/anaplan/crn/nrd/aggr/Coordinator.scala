...
import com.eci.anaplan.crn.nrd.aggr.aggregations.joiners.CarRentalNrdAggr
import com.eci.anaplan.crn.nrd.aggr.configs.Config
import com.eci.anaplan.crn.nrd.aggr.services.{S3DestinationService, StatusManagerService}
...
class Coordinator @Inject()(spark: SparkSession,
                            ...
                            anaplanDataframeJoiner: CarRentalNrdAggr,
  ...
  def coordinate(): Unit = {
    ...
    slack.info(s"Starting Car Rental by NRD Details Aggregator from: $fromDate to: $toDate")
