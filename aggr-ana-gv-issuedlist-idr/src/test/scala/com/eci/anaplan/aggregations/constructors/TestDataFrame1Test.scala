...
class TestDataFrame1Test extends SharedBaseTest with TestSparkSession {
  ...
  private val mockS3SourceService: GVIssuedSource = mock(classOf[GVIssuedSource])
  private val testDiscountPremiumDataFrame: GVIssuedlistDf = new GVIssuedlistDf(testSparkSession, mockS3SourceService)
  before {
