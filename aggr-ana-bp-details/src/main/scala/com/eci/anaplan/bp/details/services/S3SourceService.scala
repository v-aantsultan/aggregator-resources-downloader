package com.eci.anaplan.bp.details.services
...
class S3SourceService @Inject()(val sparkSession: SparkSession, config: Config,
  ...
  lazy val BPDetailsDf: DataFrame = readByDefaultCustom("ebill.flash_negative_revenue_detail","booking_issue_date_date",true)
