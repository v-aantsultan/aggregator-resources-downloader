...
@Singleton
class LoyaltyPointIDR @Inject()(spark: SparkSession, LPMutationDf: LPMutationDf, ExchangeRateDf: ExchangeRateDf,
                                GrandProductTypeDf: GrandProductTypeDf, TransactionCategoryDf: TransactionCategoryDf,
...
def get: DataFrame = {
        LPMutationDf.get.as("lp_mutation")
          ...
          .select(
            ...
            substring($"lp_mutation_idr.transaction_currency",1,2).as("customer"),
