...
import com.eci.anaplan.providers.{LPSummarySlackClient, LPSummarySparkSession}
...
class LPSummaryModule extends AbstractModule {
  override def configure(): Unit = {
    ...
    bind(classOf[SlackClient]).toProvider(classOf[LPSummarySlackClient]).asEagerSingleton()
  }
}
