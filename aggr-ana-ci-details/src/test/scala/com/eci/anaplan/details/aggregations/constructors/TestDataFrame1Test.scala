package com.eci.anaplan.details.aggregations.constructors

import com.eci.anaplan.details.utils.{SharedBaseTest, TestSparkSession}
...
class TestDataFrame1Test extends SharedBaseTest with TestSparkSession {
  ...
  private val testDiscountPremiumDataFrame: ConnectivityInternationalDf = new ConnectivityInternationalDf(testSparkSession, mockS3SourceService)
  before {
