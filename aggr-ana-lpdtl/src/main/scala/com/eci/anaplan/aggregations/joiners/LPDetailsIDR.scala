...
@Singleton
class LPDetailsIDR @Inject()(spark: SparkSession, LPMutationDf: LPDetailsDf, ExchangeRateDf: LPDetailsRateDf,
                             GrandProductTypeDf: LPDetailsGrandProductTypeDf, TransactionCategoryDf: LPDetailsTransactionCategoryDf,
                             UnderlyingProductDf: LPDetailsUnderlyingProductDf) {
