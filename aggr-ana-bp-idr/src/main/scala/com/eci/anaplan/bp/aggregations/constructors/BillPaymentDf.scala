...
@Singleton
class BillPaymentDf @Inject()(val sparkSession: SparkSession, s3SourceService: S3SourceService) {

  import sparkSession.implicits._

  def get: DataFrame = {
    s3SourceService.BillPaymentDf
      ...
      .select(
        ...
        $"`commission_scheme`".as("commission_scheme")
      )
  }
}