package com.eci.anaplan.flight.reschedule.services

import com.eci.anaplan.flight.reschedule.configs.Config
...
class S3SourceService @Inject()(val sparkSession: SparkSession, config: Config,
  ...
  lazy val FlRescheduleDf: DataFrame = readByDefaultCustomDtl("erp/reschedule_refund_to_customer","report_date")
  lazy val FulfillmentIDDf: DataFrame = readByDefaultCustomDtl("eci_sheets/ecidtpl_anaplan_fpna/Mapping fulfillment ID to wholesaler")
