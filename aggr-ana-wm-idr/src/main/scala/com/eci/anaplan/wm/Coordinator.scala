package com.eci.anaplan.wm

import com.eci.anaplan.wm.aggregations.joiners.WealthManagementIDR
import com.eci.anaplan.wm.configs.Config
import com.eci.anaplan.wm.services.{S3DestinationService, StatusManagerService}
...
class Coordinator @Inject()(spark: SparkSession,
                            ...
                            anaplanDataframeJoiner: WealthManagementIDR,
  ...
  def coordinate(): Unit = {
    ...
    slack.info(s"Starting Wealth Management Aggregator from: $fromDate to: $toDate")
