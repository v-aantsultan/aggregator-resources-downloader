...
import com.eci.anaplan.bs.summary.aggregations.joiners.BusSummary
import com.eci.anaplan.bs.summary.configs.Config
import com.eci.anaplan.bs.summary.services.{S3DestinationService, StatusManagerService}
...
class Coordinator @Inject()(spark: SparkSession,
                            ...
                            anaplanDataframeJoiner: BusSummary,
  ...
  def coordinate(): Unit = {
    ...
    slack.info(s"Starting Bus Summary Aggregator from: $fromDate to: $toDate")
