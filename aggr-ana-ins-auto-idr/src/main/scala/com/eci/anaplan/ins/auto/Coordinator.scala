...
import com.eci.anaplan.ins.auto.aggregations.joiners.InsuranceAutoIDR
import com.eci.anaplan.ins.auto.configs.Config
import com.eci.anaplan.ins.auto.services.{S3DestinationService, StatusManagerService}
...
class Coordinator @Inject()(spark: SparkSession,
                            ...
                            anaplanDataframeJoiner: InsuranceAutoIDR,
  ...
  def coordinate(): Unit = {
    ...
    slack.info(s"Starting Auto Insurance IDR Aggregator from: $fromDate to: $toDate")
