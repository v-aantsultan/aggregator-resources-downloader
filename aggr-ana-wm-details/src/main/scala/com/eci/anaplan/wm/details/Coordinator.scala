...
import com.eci.anaplan.wm.details.services.StatusManagerService
import com.eci.anaplan.wm.details.aggregations.joiners.WealthManagementDetails
import com.eci.anaplan.wm.details.configs.Config
import com.eci.anaplan.wm.details.services.{S3DestinationService, StatusManagerService}
...
class Coordinator @Inject()(spark: SparkSession,
                            ...
                            anaplanDataframeJoiner: WealthManagementDetails,
  ...
  def coordinate(): Unit = {
    ...
    slack.info(s"Starting Wealth Management Details Aggregator from: $fromDate to: $toDate")
