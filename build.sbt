...
lazy val `aggr-ana-ci-details` = (project in file("aggr-ana-ci-details"))
  .settings(
    name := "aggr-ana-ci-details",
    commonSettings,
    libraryDependencies ++= commonDeps,
    libraryDependencies ++= sparkDeps
  ).dependsOn(common).aggregate(common)
...
lazy val `aggr-ana-train-details` = (project in file("aggr-ana-train-details"))
  .settings(
    name := "aggr-ana-train-details",
    commonSettings,
    libraryDependencies ++= commonDeps,
    libraryDependencies ++= sparkDeps
  ).dependsOn(common).aggregate(common)
...
lazy val `aggr-ana-ic-paylater-r001` = (project in file("aggr-ana-ic-paylater-r001"))
  .settings(
    name := "aggr-ana-ic-paylater-r001",
    commonSettings,
    libraryDependencies ++= commonDeps,
    libraryDependencies ++= sparkDeps
  ).dependsOn(common).aggregate(common)
...
lazy val `aggr-ana-hs-idr` = (project in file("aggr-ana-hs-idr"))
  .settings(
    name := "aggr-ana-hs-idr",
    commonSettings,
    libraryDependencies ++= commonDeps,
    libraryDependencies ++= sparkDeps
  ).dependsOn(common).aggregate(common)

lazy val `aggr-ana-hs-details` = (project in file("aggr-ana-hs-details"))
  .settings(
    name := "aggr-ana-hs-details",
    commonSettings,
    libraryDependencies ++= commonDeps,
    libraryDependencies ++= sparkDeps
