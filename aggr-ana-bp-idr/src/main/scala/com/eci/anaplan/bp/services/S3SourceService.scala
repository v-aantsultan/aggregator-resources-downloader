package com.eci.anaplan.bp.services
...
class S3SourceService @Inject()(val sparkSession: SparkSession, config: Config,
  ...
  lazy val BillPaymentDf: DataFrame = readByDefaultCustom("ebill.flash_negative_revenue_detail","booking_issue_date_date",true)
