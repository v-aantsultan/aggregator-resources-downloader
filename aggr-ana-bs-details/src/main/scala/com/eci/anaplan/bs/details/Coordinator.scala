package com.eci.anaplan.bs.details

import com.eci.anaplan.bs.details.aggregations.joiners.BusDetails
import com.eci.anaplan.bs.details.configs.Config
import com.eci.anaplan.bs.details.services.{S3DestinationService, StatusManagerService}
...
class Coordinator @Inject()(spark: SparkSession,
                            ...
                            anaplanDataframeJoiner: BusDetails,
  ...
  def coordinate(): Unit = {
    ...
    slack.info(s"Starting Bus Details Aggregator from: $fromDate to: $toDate")
