...
import com.eci.anaplan.aggregations.joiners.AnaplanLoyaltyPointDtl
import com.eci.anaplan.services.{LPDetailsDestination, LPDetailsStatusManager}
 ...
 */
class LPDetailsCoordinator @Inject()(spark: SparkSession,
                                     config: LPDetailsConfig,
                                     @Named("TENANT_ID") tenantId: String,
                                     anaplanDataframeJoiner: AnaplanLoyaltyPointDtl,
                                     statusManagerService: LPDetailsStatusManager,
                                     s3DestinationService: LPDetailsDestination,
  ...
  def coordinate(): Unit = {
    ...
    slack.info(s"Starting Loyalty Point Details Aggregator from: $fromDate to: $toDate")
