...
import com.eci.anaplan.train.details.utils.{SharedBaseTest, TestSparkSession}
...
class TestDataFrame1Test extends SharedBaseTest with TestSparkSession {
  ...
  private val testDiscountPremiumDataFrame: GlobalTrainDetailsDf = new GlobalTrainDetailsDf(testSparkSession, mockS3SourceService)
  before {
    when(mockS3SourceService.GlobalTrainDf).thenReturn(mockedGlobalTrainDf)
  }
