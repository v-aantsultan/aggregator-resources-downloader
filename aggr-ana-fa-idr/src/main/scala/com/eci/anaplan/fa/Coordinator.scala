...
import com.eci.anaplan.fa.aggregations.joiners.FlightAncillariesIDR
import com.eci.anaplan.fa.configs.Config
import com.eci.anaplan.fa.services.{S3DestinationService, StatusManagerService}
...
class Coordinator @Inject()(spark: SparkSession,
                            ...
                            anaplanDataframeJoiner: FlightAncillariesIDR,
  ...
  def coordinate(): Unit = {
    ...
    slack.info(s"Starting Flight Ancillaries Aggregator from: $fromDate to: $toDate")
