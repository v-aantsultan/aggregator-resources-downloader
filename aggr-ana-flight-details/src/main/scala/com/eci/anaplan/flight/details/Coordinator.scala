package com.eci.anaplan.flight.details

import com.eci.anaplan.flight.details.aggregations.joiners.FlightFinalJoiner
import com.eci.anaplan.flight.details.configs.Config
import com.eci.anaplan.flight.details.services.{S3DestinationService, StatusManagerService}
...
class Coordinator @Inject()(spark: SparkSession,
                            ...
                            anaplanDataframeJoiner: FlightFinalJoiner,
