...
import com.eci.anaplan.flight.idr.services.{S3DestinationService, StatusManagerService}
...
class Coordinator @Inject()(spark: SparkSession,
                            ...
                            anaplanDataframeJoiner: FlFinalJoiner,
  ...
  def coordinate(): Unit = {
    ...
    slack.info(s"Starting Flight Sales in IDR Aggregator from: $fromDate to: $toDate")
