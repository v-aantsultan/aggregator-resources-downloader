 ...
 */
class GVDetailsCoordinator @Inject()(spark: SparkSession,
                                     config: GVDetailsConfig,
                                     @Named("TENANT_ID") tenantId: String,
                                     anaplanDataframeJoiner: AnaplanGiftVoucherDetails,
                                     statusManagerService: GVDetailsStatusManager,
                                     s3DestinationService: GVDetailsDestination) extends LoggerSupport {
