...
import com.eci.anaplan.fa.details.aggregations.joiners.FlightAncillariesDetails
import com.eci.anaplan.fa.details.configs.Config
import com.eci.anaplan.fa.details.services.{S3DestinationService, StatusManagerService}
...
class Coordinator @Inject()(spark: SparkSession,
                            ...
                            anaplanDataframeJoiner: FlightAncillariesDetails,
  ...
  def coordinate(): Unit = {
    ...
    slack.info(s"Starting Flight Ancillaries Details Aggregator from: $fromDate to: $toDate")
