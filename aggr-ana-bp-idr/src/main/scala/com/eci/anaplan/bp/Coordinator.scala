...
import com.eci.anaplan.bp.aggregations.joiners.BillPaymentIDR
import com.eci.anaplan.bp.configs.Config
import com.eci.anaplan.bp.services.{S3DestinationService, StatusManagerService}
...
class Coordinator @Inject()(spark: SparkSession,
                            ...
                            anaplanDataframeJoiner: BillPaymentIDR,
  ...
  def coordinate(): Unit = {
    ...
    slack.info(s"Starting Bill Payment Aggregator from: $fromDate to: $toDate")
