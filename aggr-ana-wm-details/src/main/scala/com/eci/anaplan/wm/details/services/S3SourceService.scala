package com.eci.anaplan.wm.details.services
...
class S3SourceService @Inject()(val sparkSession: SparkSession, config: Config,
  ...
  lazy val WMDetailsDf: DataFrame = readByDefaultCustom("wealth_management.gold_topup","booking_issued_date_date",true)
