...
class TestDataFrame1Test extends SharedBaseTest with TestSparkSession {
  ...
  private val mockS3SourceService: GVB2CSource = mock(classOf[GVB2CSource])
  private val testDiscountPremiumDataFrame: GVSalesB2CDf = new GVSalesB2CDf(testSparkSession, mockS3SourceService)
  before {
