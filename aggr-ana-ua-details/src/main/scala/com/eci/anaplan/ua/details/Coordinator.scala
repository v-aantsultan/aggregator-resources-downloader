...
import com.eci.anaplan.ua.details.services.StatusManagerService
import com.eci.anaplan.ua.details.aggregations.joiners.UangkuDetails
import com.eci.anaplan.ua.details.configs.Config
import com.eci.anaplan.ua.details.services.{S3DestinationService}
...
class Coordinator @Inject()(spark: SparkSession,
                            ...
                            anaplanDataframeJoiner: UangkuDetails,
  ...
  def coordinate(): Unit = {
    ...
    slack.info(s"Starting Uangku Details Aggregator from: $fromDate to: $toDate")
