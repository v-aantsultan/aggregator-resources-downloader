...
import com.eci.anaplan.at.aggr.aggregations.joiners.AirportTransportJoinerDf
import com.eci.anaplan.at.aggr.configs.Config
import com.eci.anaplan.at.aggr.services.{S3DestinationService, StatusManagerService}
...
class Coordinator @Inject()(spark: SparkSession,
                            ...
                            anaplanDataframeJoiner: AirportTransportJoinerDf,
  ...
  def coordinate(): Unit = {
    ...
    slack.info(s"Starting Airport Transport in Details Aggregator from: $fromDate to: $toDate")
