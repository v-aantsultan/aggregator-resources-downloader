...
import com.eci.anaplan.cr.idr.services.StatusManagerService
import com.eci.anaplan.cr.idr.aggregations.joiners.CouponReportIDR
import com.eci.anaplan.cr.idr.configs.Config
import com.eci.anaplan.cr.idr.services.{S3DestinationService, StatusManagerService}
...
class Coordinator @Inject()(spark: SparkSession,
                            ...
                            anaplanDataframeJoiner: CouponReportIDR,
