package com.eci.anaplan.wm.services
...
class S3SourceService @Inject()(val sparkSession: SparkSession, config: Config,
  ...
  lazy val WealthManagementDf: DataFrame = readByDefaultCustom("wealth_management.gold_topup","booking_issued_date_date",true)
