package com.eci.anaplan.wm.details.module

import com.eci.anaplan.wm.details.providers.SparkSessionProvider
import com.eci.anaplan.wm.details.providers.{SlackClientProvider, SparkSessionProvider}
