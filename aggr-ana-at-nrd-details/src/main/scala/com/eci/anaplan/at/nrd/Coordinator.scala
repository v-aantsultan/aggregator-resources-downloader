...
import com.eci.anaplan.at.nrd.aggregations.joiners.AirportNRDDetails
import com.eci.anaplan.at.nrd.configs.Config
import com.eci.anaplan.at.nrd.services.{S3DestinationService, StatusManagerService}
...
class Coordinator @Inject()(spark: SparkSession,
                            ...
                            anaplanDataframeJoiner: AirportNRDDetails,
  ...
  def coordinate(): Unit = {
    ...
    slack.info(s"Starting Airport Transfer by NRD Details Aggregator from: $fromDate to: $toDate")
