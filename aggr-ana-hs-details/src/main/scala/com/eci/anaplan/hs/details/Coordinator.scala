...
import com.eci.anaplan.hs.details.aggregations.joiners.HealthServiceDetails
import com.eci.anaplan.hs.details.configs.Config
import com.eci.anaplan.hs.details.services.{S3DestinationService, StatusManagerService}
...
class Coordinator @Inject()(spark: SparkSession,
                            ...
                            anaplanDataframeJoiner: HealthServiceDetails,
  ...
  def coordinate(): Unit = {
    ...
    slack.info(s"Starting Health Service Details Aggregator from: $fromDate to: $toDate")
