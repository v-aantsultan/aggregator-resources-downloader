package com.eci.anaplan.cr.idr.module

import com.eci.anaplan.cr.idr.providers.SparkSessionProvider
import com.eci.anaplan.cr.idr.providers.{SlackClientProvider, SparkSessionProvider}
