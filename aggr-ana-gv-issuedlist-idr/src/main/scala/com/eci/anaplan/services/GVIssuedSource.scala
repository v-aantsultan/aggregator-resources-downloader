...
class GVIssuedSource @Inject()(val sparkSession: SparkSession,
                               ...
                               @Named("TENANT_ID") val tenantId: String) extends GVIssuedPathFetcher {
  ...
  lazy val GVIssuedlistDf: DataFrame = readByDefaultIssuedDateDWH("gift_voucher.gv_issuedlist") // (e.g: sales_delivery)
